...
const socials = [
  {
    Icon: FaLinkedin,
    label: "Linkedin",
    href: "https://www.linkedin.com/in/kawsar-ahmed-rahim-b52076335",
  },
    ...
    >
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="relative hidden lg:block">
          <div
            className="absolute top-1/2 -transparent-y-1/2 pointer-events-none"
            style={{
              right: "10px",
              ...
              opacity: 0.32,
              background:
                "conic-gradient(from 0deg, #111cd8d2, #00bf8f, #302b63, #1cd8d2)",
            }}
          />
          <motion.img
            src={avator}
